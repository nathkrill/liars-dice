  ...
  */
  ...
  function (_super) {
    ...
    function Socket(secure, host, port, path, key, pingInterval) {
      ...
      _this._baseUrl = wsProtocol + host + (port ? ":" + port : '') + path + "peerjs?key=" + key;
      return _this;
    }
  ...
  function () {
    ...
    API.prototype._buildUrl = function (method) {
      ...
      var url = protocol + this._options.host + (this._options.port ? ':' + this._options.port : '') + this._options.path + this._options.key + "/" + method;
